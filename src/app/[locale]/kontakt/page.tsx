          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+420777134829" className="text-green-700 hover:text-green-800 mt-1 block">+420 777 134 829</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@filtrex.cz" className="text-green-700 hover:text-green-800 mt-1 block">info@filtrex.cz</a>
              </div>
            </div>
          </div>
        </div>
